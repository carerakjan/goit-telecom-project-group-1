...
html = """
        ...
        <ul>
            <li>
                ...
                <ul>
                    ...
                    <li>Кнопка "Вимоги показників вводу" відображає таблицю з мінімально та максимально допустимими значеннями полів для вводу у форму одиночного прогнозування.</li>
            ...
            <li>
                <strong>Передбачення для списку юзерів:</strong>
                <ul>
                    <li>Вибір цієї опції дозволяє прогнозувати відтік клієнтів використовуючи датасет.</li>
                    <li>Для визначення відтоку клієнтів використовуючи датасет натисніть вкладку "Передбачення для списку юзерів".</li>
                </ul>
            </li>
        </ul>
        ...
        <h2>7. Сторінка: Передбачення для списку юзерів</h2>
        <ul>
            <li>
                <strong>Введення Даних:</strong>
                <ul>
                    <li>Щоб перейти на сторінку передбачення для списку юзерів натисніть на кнопку "Передбачення для списку юзерів".</li>
                    <li>Щоб вибрати модель прогнозування, натисніть на поле "Оберіть модель для використання" та у випадаючому меню виберіть потрібну модель прогнозування. Модель "decision_tree" встановлена за замовчуванням.</li>
                </ul>
            </li>
            <li>
            ...
            <li>
                ...
                <ul>
                    ...
                    <ul>
                        ...
                        <li><code>download_avg</code>: середня швидкість завантаження.</li>
                        <li><code>upload_avg</code>: середня швидкість вивантаження.</li>
